...
I recorded screen demos that show the system working for a handful of prompts.

```html
<video controls src="examples/videos/demo_query_1.mp4" style="max-width: 100%; height: auto;" preload="metadata"></video>
```
