#!/usr/bin/env python3
"""
predict_pipeline_fixed.py

This is a corrected and robust version of your shortlist + CLAP rerank pipeline.
Improvements/fixes:
 - robust .npy header parsing using numpy.lib.format helpers (imports added)
 - memmap fallback to header-aware per-row reader on Windows (avoids WinError 8)
 - streaming batch rerank that reduces batch size on OOM and avoids loading full file
 - small defensive fixes and clearer logging

Drop this file into your pipe folder and call it the same way as before.
"""
import argparse
