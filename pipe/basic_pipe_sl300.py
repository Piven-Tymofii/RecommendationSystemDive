...
def main():
    ...
    p.add_argument("--clap-audio", default=r"..\db_create\data\embeddings\embs_audio\clap_audio_processed.npy", help="CLAP audio embeddings (n x d)")
    ...
    # optional: return pandas for further scripting
    df_out = pd.DataFrame(rows)
    # save to tmp file for quick copy/paste
